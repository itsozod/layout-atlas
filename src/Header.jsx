  ...
  return (
    <header className="header">
      ...
      <div className="big-part">
        <h1 className="blog">
          More <span className="answer">answers</span> to your <br></br> <span className="question">questions</span> in our blog
        </h1>

        <p className="health">
          Sharing knowledge on how genes, gut bacteria <br></br> and life style affect at
          your health
        </p>
      </div>
    </header>
